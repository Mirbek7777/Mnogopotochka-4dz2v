...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread a = new Thread(() -> {
            ...
            System.out.println("Maq qty of " + letter + " int all texts: " + maxA);
        });
        a.start();
        ...
        Thread b = new Thread(() -> {
            ...
            System.out.println("Maq qty of " + letter + " int all texts: " + maxB);
        });
        b.start();
        ...
        Thread c = new Thread(() -> {
            ...
            System.out.println("Maq qty of " + letter + " int all texts: " + maxC);
        });
        c.start();
